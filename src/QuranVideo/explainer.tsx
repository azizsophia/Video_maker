...
export const FULL_VISUAL_SCENES = ["app-showcase", "carlyle", "baqarah-mirror", "baqarah-ring", "revelation-timeline", "ringdiagram", "manuscript", "match-compare", "carbon-timeline", "confidence-meter", "preservation-timeline", "prophecy-timeline", "golden-horn", "walls", "sieges-failed", "cannon", "fell-stamp", "march-map", "kaaba-protected", "stones-from-sky", "isnad-chain", "rijal-card", "bukhari-funnel", "grading-scale", "alkahf-name", "alkahf-info", "alkahf-structure", "poll-card", "alkahf-lessons", "decoded-name", "decoded-info", "decoded-structure", "decoded-poll", "decoded-lessons", "sahaba-name", "sahaba-dossier", "sahaba-journey", "sahaba-poll", "sahaba-virtues", "shop-waitlist", "rahman-dual", "rahman-gardens", "rahman-rhythm"];
