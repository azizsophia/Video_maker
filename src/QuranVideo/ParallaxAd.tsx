...
export const ParallaxAd: React.FC<{ audioSrc?: string; frames?: number }> = ({ audioSrc, frames }) => {
  ...
  const cta = (
    <>
      <div style={{ fontFamily: JOST, fontWeight: 400, fontSize: wide ? 30 : 32, letterSpacing: 1, color: "rgba(246,244,239,0.88)", marginBottom: 24 }}>Launching this month. Join the waitlist for 15% off your first order</div>
